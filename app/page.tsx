      ...
      <main style={{ flex: 1, overflow: "auto", padding: "32px 32px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 28 }}>
          ...
          <div style={{ flex: 1, position: "relative", maxWidth: 360 }}>
            <span style={{
              ...
              pointerEvents: "none", display: "flex", zIndex: 2,
            }}>
          ...
          <button className="btn-primary" style={{ flexShrink: 0, marginLeft: "auto" }} onClick={() => setShowNewChart(true)}>
            <PlusIcon /> New Chart
          </button>
        </div>
        ...
        {charts.length === 0 && (
          <div className="glass" style={{ padding: "64px 32px", textAlign: "center" }}>
            ...
            <button className="btn-primary" onClick={() => setShowNewChart(true)}>
